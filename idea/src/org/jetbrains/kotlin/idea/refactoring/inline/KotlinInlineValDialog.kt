...
class KotlinInlineValDialog(
    ...
    private val isLocal get() = (callable as KtProperty).isLocal

    override val kind get() = if (isLocal) "local variable" else "property"

    private val simpleLocal get() = isLocal && (reference == null || occurrencesNumber == 1)
